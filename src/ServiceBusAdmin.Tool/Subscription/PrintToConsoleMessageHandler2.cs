...
{
    public class PrintToConsoleMessageHandler2
    {
        private readonly OutputFormatOption _outputFormat;
        private readonly Encoding _encoding;
        private readonly SebaConsole _console;

        public PrintToConsoleMessageHandler2(OutputFormatOption outputFormat, string encodingName, SebaConsole console)
        {
        ...
        public Task Handle(IMessage2 message)
        {
